...
const Hero = () => {
  return (
    <div className='w-full h-[100vh] flex justify-center items-center font-extrabold'>
        <div className='w-[60%] h-[50%] flex p-5 justify-center gap-4'>
            ...
            <motion.div className='w-[40%] h-full rounded-full flex justify-center items-center'
                        initial={{ opacity: 0, x: 150 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 1.2, ease: "easeOut"}}>
